    ...
    public class MoviesRepo : EntityBaseRepository<Movie>, IMoviesRepo
    {
        ...
        public async Task AddNewMovieAsync(NewMovieVM data)
        {
            var newMovie = new Movie()
            {
                ...
                CinemaId = data.CinemaId,                       //as when not selected any item in create give Field is required
            ...
            foreach (var actorId in data.ActorIds)       //to add all the actors that are selected while Creating a movie in table => Actor_Movies 
            {
        ...
        public async Task UpdateMovieAsync(NewMovieVM data)
        {
            ...
            //Remove existing actors by MovieId
        ...
        public async Task<NewMovieDropdownsVM> GetNewMovieDropdownsValues()      //To Show the DropDown menu to select the items
        {

            var Values = new NewMovieDropdownsVM()
            {
